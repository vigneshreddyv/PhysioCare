                ...
                {patients.map((patient) => (
                  <tr key={patient.id} className="hover:bg-surface-container-low transition-colors duration-150">
                    ...
                    <td className="p-4 text-right">
                      <button className="text-primary hover:text-secondary text-sm font-semibold hover:underline mr-3">Edit</button>
                      <button className="text-on-surface-variant hover:text-on-surface text-sm font-semibold hover:underline">History</button>
                    </td>
                  </tr>
                ))}
              </tbody>
